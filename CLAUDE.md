...
- `lua/mappings.lua` — Global keymaps (`\` for NvimTree, `<leader>q` for diagnostics). Window/tmux nav with C-hjkl comes from nvim-tmux-navigation in `lua/plugins/tmux.lua`.
